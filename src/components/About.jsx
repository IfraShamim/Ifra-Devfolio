...
const About = () => {
  return (
    <div className='px-6 md:px-[10rem]' id='about'>
      ...
      <div className="py-10">
      <h1 className="text-3xl font-bold text-center mb-8 text-[#c18572]">My Journey</h1>
      <div className="grid md:grid-cols-2 gap-2">
        {/* Education Section */}
        <div className="text-[#c18572] w-[100%] p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-4">Education</h2>
          <ul className="space-y-4">
            <li>
              <b>2024</b> - Bachelor's in Computer Science  
              <p className="text-sm text-[#cdad9e]">Sindh Madressatul Islam University</p>
            </li>
            <li>
              <b>2020</b> - Intermediate (Pre-Medical)  
              <p className="text-sm text-[#cdad9e]">BAMM PECHS Govt. Degree Girls College for Women</p>
            </li>
            <li>
              <b>2018</b> - Matriculation (Pre-Medical)  
              <p className="text-sm text-[#cdad9e]">Millennium's Education System</p>
            </li>
            <li>
              <b>2024</b> - MERN Stack Development  
              <p className="text-sm text-[#cdad9e]">Saylani Mass IT Training Program</p>
            </li>
          </ul>
        </div>

        {/* Experience Section */}
        <div className="text-[#c18572] p-6 rounded-lg shadow-md">
          ...
          <ul className="space-y-4">
            ...
            <li>
              ...
              <p className="text-sm text-[#cdad9e]">Worked on various projects to gain industry experience</p>
            </li>
          </ul>
        </div>
      </div>
