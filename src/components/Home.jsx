  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left max-w-screen-lg mx-auto px-6 md:px-8 py-10">
      ...
      <div className="md:w-1/2">
        ...
        <p className="font-semibold text-[1.5rem] mb-2">
          A{" "}
          <ReactTyped
        ...
        <div className="flex gap-2 justify-center md:justify-start mt-4 font-semibold">
          with <Btn /> experience
        </div>
      ...
      <div className="mt-10 md:mt-0 md:w-1/2">
        <img
          className="mx-auto w-[18rem] md:w-[20rem]"
          src="MyPic.png"
          alt="Ifra Shamim"
        />
      </div>
